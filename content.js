...
const home=()=>`<div class="story-backdrop" aria-hidden="true">
  <div class="story-layer story-woman active"><img src="${A.artist}" alt=""></div>
  <div class="story-layer story-hands"><img src="${A.h1}" alt=""></div>
  <div class="story-layer story-feet"><img src="${A.feet}" alt=""></div>
  <div class="story-layer story-brows"><img src="${A.brows}" alt=""></div>
  <div class="story-light"></div><div class="story-vignette"></div>
</div>
<section class="hero grain" data-scene="0"><div class="hero-pin"><div class="ambient"><i></i><i></i><i></i></div><div class="hero-media"><img class="hero-poster" src="${A.hero}" alt="Composição editorial de beleza"><video class="hero-video" src="${A.video}" poster="${A.hero}" muted playsinline autoplay loop></video></div><div class="hero-shade"></div>
<div class="hero-film-window" aria-hidden="true"><video src="${A.video}" poster="${A.hands}" muted autoplay loop playsinline></video><span>ATELIER / MOVIMENTO</span></div>
<div class="hero-reflection-line" aria-hidden="true"></div>
<div class="lacquer-orb"></div><div class="shell hero-copy"><div class="hero-copy-inner"><div class="eyebrow">Maíra Beauty Atelier • mãos • pés • sobrancelhas</div><h1 class="display"><span class="hero-line"><span>BELEZA</span></span><span class="hero-line"><span>DESENHADA EM</span></span><span class="hero-line"><span>CADA DETALHE.</span></span></h1><p class="hero-sub">Uma experiência de cuidado onde técnica, presença e acabamento se encontram. O site acompanha o gesto — e não apenas mostra o resultado.</p><div class="hero-actions"><a class="btn primary" href="/agendar">Agendar meu horário</a><a class="btn" href="/portfolio">Ver portfólio</a></div></div></div><div class="cinema-cut" aria-hidden="true"></div><div class="scroll-mark">Deslize para continuar ↓</div></div></section>
<section class="material-bridge bridge-lacquer" aria-hidden="true"><div class="bridge-core"></div><div class="bridge-copy display">LACA</div></section>
...
<section class="material-bridge bridge-pearl" aria-hidden="true"><div class="bridge-core"></div><div class="bridge-copy display">PÉROLA</div></section>
...
<section class="material-bridge bridge-precision" aria-hidden="true"><div class="precision-thread"></div><div class="bridge-copy display">PRECISÃO</div></section>
